...
insert into role_rules(role_id, rules_id) values (48, 35);
...
insert into item(user_id, category_id, state_id) values (2, 2, 3);
...
insert into comments(comments, item_id) values ('bbb', 3);
